...
package org.opennms.timeseries.impl.pgtimeseries.util.rrd.v1;
...
public class RRDv1 extends AbstractRRD {
    ...
    /* (non-Javadoc)
     * @see org.opennms.timeseries.impl.pgtimeseries.util.rrd.AbstractRRD#getRras()
     */
    @XmlElement(name="rra")
    ...
    /* (non-Javadoc)
     * @see org.opennms.timeseries.impl.pgtimeseries.util.rrd.AbstractRRD#getDataSources()
     */
    @XmlElement(name="ds")
    ...
    /* (non-Javadoc)
     * @see org.opennms.timeseries.impl.pgtimeseries.util.rrd.AbstractRRD#createRRD()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.opennms.timeseries.impl.pgtimeseries.util.rrd.AbstractRRD#addDataSource(org.opennms.timeseries.impl.pgtimeseries.util.rrd.AbstractDS)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.opennms.timeseries.impl.pgtimeseries.util.rrd.AbstractRRD#getDataSource(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.opennms.timeseries.impl.pgtimeseries.util.rrd.AbstractRRD#addRRA(org.opennms.timeseries.impl.pgtimeseries.util.rrd.AbstractRRA)
     */
    @Override
