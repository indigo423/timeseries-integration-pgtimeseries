...
import org.opennms.timeseries.impl.pgtimeseries.util.rrd.DoubleAdapter;
...
public class RRA extends AbstractRRA {
    ...
    /* (non-Javadoc)
     * @see org.opennms.timeseries.impl.pgtimeseries.util.rrd.AbstractRRA#createSingleRRA(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.opennms.timeseries.impl.pgtimeseries.util.rrd.AbstractRRA#formatMergeable(org.opennms.timeseries.impl.pgtimeseries.util.rrd.AbstractRRA)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.opennms.timeseries.impl.pgtimeseries.util.rrd.AbstractRRA#hasAverageAsCF()
     */
    @Override
